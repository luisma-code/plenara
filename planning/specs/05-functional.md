...
[System: transcription finalized on-device; written as a private journal_entry record that syncs — journal/YYYY-MM-DD-<id>.json (unique per entry; Spec 01 §12.3)]
