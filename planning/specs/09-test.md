...
**Status:** v0.2 — amended 2026-08-17. Test totals are generated by the runner and are not frozen in prose. Per-tier coverage, unclassified import failure, generated 05a conformance counts, secret isolation, and calibrated visual-verifier checks are live in `tool/precheck.sh`.
