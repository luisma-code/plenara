...
- a Focus-first home capped to the eight highest-priority due people, with an explicit expansion for the remainder, global person search, combinable circle/proximity filters carrying membership/due counts, and urgency-first filtered/all-people views rather than an always-expanded alphabetical address book;
